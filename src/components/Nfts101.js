	...
	return (
		<div className="nfts101" id="nfts101">
			...
			<div className="wrapper">
				...
				<Accordion title="Why GEN-X NFTS?">
					<p>
						Gen-X is small but mighty. We wield the most cultural power, founded
						more than half of the start-up companies and businesses in America,
						and owned the 2022 Super Bowl ads and half-time show.
					</p>

					<p>
						Our music rocks, our movies rock, our style rocks (well, at least it
						used to)!
					</p>

					<p>
						So, isn’t it time there’s finally an NFT for OUR generation, so we
						can relive our youth in Web3?
					</p>

					<p>
						Our mission/purpose here at Gen-X NFTs is to create ACCESS,
						EDUCATION + REPRESENTATION for everyone in this new and ever
						evolving Web3 space.
					</p>

					<p>
						<strong>ACCESS:</strong> We’re gonna ease you into the NFT space. If
						you aren’t ready to deal with a crypto wallet, you can mint (buy) a
						Latchkey Kids NFT using a CREDIT CARD. This is HUGE. Most NFTs don’t
						offer a Credit Card option yet, and the reality is that some folks
						just don’t quite understand the often overwhelming process of
						setting up and funding a crypto wallet or moving crypto around. We
						made the decision early to wait to mint until we can seamlessly sell
						these NFTs via Credit Card, so the process can be easy breezy. And
						we plan to come in at a VERY affordable mint price, so ANYONE who
						wants one will be able to experience the thrill of buying an NFT!
					</p>

					<p>
						<strong>EDUCATION:</strong> You’re gonna learn the ABCs of NFTs as a
						part of this community. From how to set up your crypto wallet, to
						buying and swapping crypto, to minting your first NFT. It would be
						such a shame for our generation to get left behind because the
						education isn’t there to help get us into this brand new tech space,
						so Latchkey Kids are here to help break down the barriers to entry,
						anyway we can.{' '}
					</p>

					<p>
						<strong>REPRESENTATION:</strong> This is the NFT collection for
						anyone who feels overwhelmed, confused, and even skeptical,
						ambivalent or annoyed by NFTs. You have found your people! Also,
						nostalgia is a powerful drug. These are relatable NFTs that you will
						want to have repping you in Web3. I mean, who wouldn’t want to
						venture back into simpler times with other likeminded kids who came
						of age in the late 70s/80s/early 90s – and lived to tell about it?{' '}
					</p>

					<p>
						<strong>WE’LL MEET YOU WHEREVER YOU ARE:</strong> Some of you are
						already ALL IN. Some of you are just NFT curious. Some of you are
						even scared or nervous about this brave new world coming. You might
						fear the future for your kids, and what all this tech might do to
						them. You may think NFTs are bad for the environment. Or a scam. No
						matter what you think or believe, we are here to help educate and
						inform you, so we can really dive deep into the good, bad and iffy
						of the NFT world. It’s not all good – but it’s definitely not all
						bad! Let’s see it from all sides, together.
					</p>
				</Accordion>
			</div>
		</div>
